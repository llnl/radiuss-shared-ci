...
If you're setting up CI for the first time, start here:

1. :doc:`prerequisites` - Check that you have everything you need
2. :doc:`five-minute-setup` - Get a basic pipeline running quickly
3. :doc:`choosing-your-path` - Decide which machines and features to enable

Already Using RADIUSS Shared CI?
=================================

If you're using the legacy include-based approach and want to migrate to
components:

→ :doc:`../user_guide/components_migration`
